...
def cs_util_create_compute_shader(context: mgl.Context, shader_file: str):
    '''
    创建一个计算着色器对象
    :param context:
    :param shader_file:
...
def cs_util_create_compute_shader_width_code(context: mgl.Context, code: str):
    '''
    创建一个计算着色器对象
    :param context:
    :param shader_file:
...
def cs_util_bind_texture_to_shader(shader: mgl.ComputeShader, texture: mgl.Texture, location: int):
    '''
    将纹理绑定到着色器
    :param shader:
    :param texture:
